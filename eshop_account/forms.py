...
class RegisterForm(forms.Form):
    user_name = forms.CharField(
        ...
        validators=[
            ...
            validators.MinLengthValidator(1, 'تعداد کاراکترهای وارد شده نمیتواند کمتر از 1 باشد')
        ]
    )
    ...
    def clean_email(self):
        ...
        if len(email) > 100:
            raise forms.ValidationError('تعداد کاراکترهای ایمیل باید کمتر از 100 باشد')
